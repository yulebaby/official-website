$(function(){
	var oul = $('.supportwrapBox ul');
	var ali = $('.supportwrapBox ul li');
	var numLi = $('.supportwrapBox ol li');
	var aliWidth = $('.supportwrapBox ul li').eq(0).width();
	var _now = 0;	//这个是控制数字样式的计数器
	var _now2 = 0;	//这个是控制图片运动距离的计数器
	var timeId;
	var aimg = $('.supportwrapBox ul img');
	var op = $('.supportwrapBox p');
